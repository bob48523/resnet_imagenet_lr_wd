...
def main():
    ...
    trainLoader = torch.utils.data.DataLoader(
        dset.ImageFolder('/datadisk/A/liubaoen/data/TINYIMAGENET_1000_80/train/', transforms.Compose([
            transforms.Scale(72),
    ...
    valLoader = torch.utils.data.DataLoader(
        dset.ImageFolder('/datadisk/A/liubaoen/data/TINYIMAGENET_1000_80/val/', transforms.Compose([
            transforms.Scale(72),
...
def adjust_opt(optAlg, optimizer,base_lr, epoch):
    if optAlg == 'sgd':
        if epoch < 150: lr = 0.1
        elif epoch == 151: lr = base_lr*0.1
        elif epoch == 226: lr = base_lr*0.01
        else: return
